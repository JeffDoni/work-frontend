        ...
        <section className={styles.exposeProduct}>
          <div className={styles.primaryProduct}>
            <div className={styles.detailsProduct}>
              <Image
                src={list[ramdomNumber].thumbnail}
                alt={list[ramdomNumber].title}
                width={100}
                height={100}
              />
              <div>
          ...
          <div className={styles.primaryProduct}>
            <div className={styles.detailsProduct}>
              <Image
                src={list[ramdomNumber2].thumbnail}
                alt={list[ramdomNumber2].title}
                width={100}
                height={100}
              />
              <div>
                ...
                <p>
                  <a href={list[ramdomNumber2].permalink} target="_blanck">
                    Clique aqui
                  </a>{" "}
